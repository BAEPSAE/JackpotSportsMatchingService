...
<script>
								...
								.on(
										...
										function() {
											...
											function pop() {
												window
														.open(
																'${pageContext.request.contextPath}/map_m.jsp',
																'경기장 찾기',
																'resizable=no scrollbars=yes top=100 left=100 width=1080 height=600');
											}
										});
								...
								.on(
										...
										function() {
											...
											function pop() {
												window
														.open(
																'${pageContext.request.contextPath}/map2_m.jsp',
																'희망 위치 찾기',
																'resizable=no scrollbars=yes top=100 left=100 width=1080 height=600');
											}
										});
	...
	function clearNotice() {
		...
		$('#notLeader').css('display', 'none');
		$('#notEnoughMember').css('display', 'none');
	...
	function data() {
		...
		var returnData = {
			"sports" : sports,
			"cutDate" : cutDate,
			"matching.ground_Hold" : ground_Hold,
			"matching.latitude" : latitude,
			"matching.longitude" : longitude,
...
<body>
			...
			<div class="js-sidebar-content">
             ...
             looks good, so adding it and enhancing with notifications -->
				...
				<ul class="sidebar-nav">
					<li class="active"><a href="#sidebar-ui"
						data-toggle="collapse" data-parent="#sidebar"> <span
							class="icon"> <!-- <i class="glyphicon glyphicon-tree-conifer"></i> -->
					...
					<li><a class="collapsed" href="#sidebar-forms"
						data-toggle="collapse" data-parent="#sidebar"
						aria-expanded="false"> <span class="icon"> <i
								class="glyphicon glyphicon-star"></i>
						</span> Ranking <i class="toggle fa fa-angle-down"></i>
					</a>
					...
					<li><s:a action="list" namespace="/board">
				...
				<div class="navbar-header">
					<ul class="nav navbar-nav">
						<li class="nav-item">
							...
							<a class="hidden-lg-up nav-link" id="nav-collapse-toggle"
							href="#" data-html="true" title="Show/hide<br>sidebar"
					...
					<!-- xs & sm screen logo -->
					<s:a class="navbar-brand hidden-md-up" action="index" namespace="/">
						<i class="fa fa-circle text-gray mr-n-sm"></i>
						<i class="fa fa-circle text-warning"></i> &nbsp; 골목대장 &nbsp; <i
							class="fa fa-circle text-warning mr-n-sm"></i>
					...
					<ul class="nav navbar-nav pull-xs-right">
						<li class="dropdown nav-item"><a href="#"
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><s:a class="dropdown-item" action="logout"
										namespace="/player">
										<i class="fa fa-sign-out"></i> &nbsp; Log Out</s:a></li>
							</ul></li>
					</ul>
				</div>
			</div>
		...
		<div class="content-wrap">
			<main id="content" class="content" role="main"> <!-- 화면 좌우이동 -->
			<style>
body {
	overflow-x: visible;
}
</style>
			<%-- <section class="widget"> --%> <!-- <div class="widget-body">
        <div> -->
			<div class="row">
							...
							<div class="panel-heading collapsed" style="text-align: center;">
								<h6 class="panel-title">
									<a class="collapsed" data-toggle="collapse"
										...
										class="label label-pill label-warning">01</span><span
										style="font-size: 1.5em; font-weight: bold;"> 종목 선택</span> <i
										class="fa fa-angle-down pull-xs-right"></i>
									</a>
								</h6>
							</div>
							<div id="collapseOne" class="panel-collapse collapse in">
								<div class="panel-body">
									...
									<div class="widget-body" style="text-align: center;">
										<form role="form">
											<label for="datepicker2i"> <span class="help-block"
												style="font-size: 1.1em;"> 종목당 한 번에 매칭을 요청할 수 있는 횟수는
													1회입니다. </span>
											</label>
											<fieldset>
												<div class="form-group" style="text-align: center;">
													<div style="float: left; width: 50%;" id="sports1">
														<a href="#" class="block1"><input type="hidden"
															id="type1" value="1" /> <img src="images/12.jpg"
															style="width: 100%;"> <span class="price"><span></span><span
																style="font-size: 1.5em;">SOCCER</span><strong></strong></span>
														</a>
													</div>
													<div style="float: left; width: 50%;" id="sports2">
														<a href="#" class="block1"><input type="hidden"
															id="type2" value="2" /> <img src="images/13.jpg"
															style="width: 100%;"> <span class="price"><span></span><span
																style="font-size: 1.5em;">Baseball</span><strong></strong></span>
														</a>
													</div>
													<div style="float: left; width: 50%;" id="sports3">
														<a href="#" class="block1"><input type="hidden"
															id="type3" value="3" /> <img src="images/14.jpg"
															style="width: 100%;"> <span class="price"><span></span><span
																style="font-size: 1.5em;">Pingpong</span><strong></strong></span>
														</a>
													</div>
													<div style="float: left; width: 50%;" id="sports4">
														<a href="#" class="block1"><input type="hidden"
															id="type4" value="4" /> <img src="images/15.jpg"
															style="width: 100%;"> <span class="price"><span></span><span
																style="font-size: 1.5em;">Bowling</span><strong></strong></span>
														</a>
													</div>
												</div>
												<!-- form=group -->
												...
												<div id="gostop" style="margin-left: 40%">
													<div style="display: none;" id="stop">
														<label for="datepicker2i"
															style="float: left; font-size: 1.3em;"> <span
															class="help-block" id="comecome"> <br>이미 <span
																style="font-weight: bold;">매칭 진행 중</span>인 종목입니다!<br>
																<br>
																<button class="btn btn-inverse width-100 mb-xs"
																	role="button" id="showSc">스케줄 보기</button>
														</span>
														</label>
													</div>
													<div style="display: none;" id="notLeader">
														<label for="datepicker2i"
															style="float: left; font-size: 1.3em;"> <span
															class="help-block" id="comecome"> <br>팀장만 신청할
																수 있습니다!<br> <br>
																<button class="btn btn-inverse width-100 mb-xs"
																	role="button" id="teamView">팀 보러가기</button>
														</span>
														</label>
													</div>
													<div style="display: none;" id="notEnoughMember">
														<label for="datepicker2i"
															style="float: left; font-size: 1.3em;"> <span
															class="help-block" id="comecome"> <br>팀에 사람이
																모자랍니다!<br> <br>
																<button class="btn btn-inverse width-100 mb-xs"
																	role="button" id="teamView">팀 보러가기</button>
														</span>
													...
													<div
														style="display: inline; margin-left: -100%; display: none;"
														id="go">
														<label for="datepicker2i" style="font-size: 1.3em">
															<span class="help-block"> <br> <br>좋습니다.
																<span style="font-weight: bold;">매칭을 계속 진행</span>하세요!
														</span>
														</label>
													</div>
												</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading collapsed" style="text-align: center;">
								<h6 class="panel-title">
									<a class="collapsed" data-toggle="collapse"
										data-parent="#accordion" href="#collapseOne"> <span
										class="label label-pill label-danger">02</span><span
										style="font-size: 1.5em; font-weight: bold;"> 날짜 선택</span> <i
										class="fa fa-angle-down pull-xs-right"></i>
									</a>
								</h6>
							</div>
							<div id="collapseOne" class="panel-collapse collapse in">
								<div class="panel-body">
									...
									<div class="widget-body"
										style="text-align: center; margin-left: 17%;">
										<form role="form">
											<fieldset>
												<div class="form-group" style="text-align: center;">
													<label for="datepicker2i" style="margin-left: -10%;">
														<span class="help-block"> 날짜와 시간을 선택해 주세요 </span>
													</label>
							...
							<div class="panel-heading" style="text-align: center;">
								<h6 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion"
										href="#collapseTwo" id="locationOwn"> <span
										class="label label-pill label-success">03</span><span
										style="font-size: 20px; font-weight: bold;"> 장소 선택</span> <i
										class="fa fa-angle-down pull-xs-right"></i>
									</a>
								</h6>
							</div>
												...
												<div class="form-group row">
													...
													<div class="widget-body">
														<div class="col-sm-3" style="text-align: center;">
															<span class="help-block"> 이미 예약해 둔 구장이나 정해진 장소가
																있나요? </span> <input type="button"
																class="btn btn-default btn-block" id="yesIDo"
																value="예, 있습니다" "/>
															<div class="col-sm-12"
																style="text-align: center; margin-top: 5px;"
																id="yesIDo_window">
																<input type="text" class="form-control" id="ground_name"
																	placeholder="경기장 이름" readonly="readonly" /><br>
															</div>
															<input type="button" class="btn btn-default btn-block"
																id="noIDont" value="아니오, 없습니다" />
															<div style="margin-top: 5px;">
																<!-- 위도 -->
																<div class="col-sm-12">
																	<div class="input-group">
																		<span class="input-group-addon"><i
																			class="glyphicon glyphicon-resize-vertical"></i></span> <input
																			id="la" class="form-control" type="text"
																			placeholder="위도" readonly="readonly">
																	</div>
																</div>
																<!-- 경도 -->
																<div class="col-sm-12">
																	<div class="input-group">
																		<span class="input-group-addon"><i
																			...
																			id="ln" class="form-control" type="text"
																			placeholder="경도" readonly="readonly">
																	</div>
																</div>
															</div>
															<!-- no -->
				...
				<div class="col-lg-6">
					...
					<button type="button" style="height: 100px;"
						class="btn btn-warning btn-block" id="matching">
						<span style="font-size: 30px;">MATCHING!</span>
					</button>
				</div>
				<input type="hidden" id="type" value="0" /> <input type="button"
					id="resize" style="visibility: hidden;" /> <br> <br> <br>
			</div>
			<!-- row --> <!-- </div>
        </div>widget body --> <%-- </section> --%><!-- widget --> </main>
		</div>
		<!-- 들고 오는 js -->
