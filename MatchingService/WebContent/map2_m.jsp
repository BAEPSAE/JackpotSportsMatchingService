...
<head>
    ...
    <script type="text/javascript">
    	...
    	function setPlace(la, ln) {
    		opener.document.getElementById("la").value=la;
    		opener.document.getElementById("ln").value=ln;
    		this.close();
    	}
    </script>
  	<style type="text/css">
		...
		#menu_wrap {height:20em; position:absolute;top:0;left:0;bottom:0;width:250px;margin:10px 0 30px 10px;padding:5px;overflow-y:auto;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
...
<body>
	         <div class="col-lg-12"><br>
	             <section class="widget">
	                 	<div><input type="text" class="form-control" id="la" style="float:left; width: 240px; text-align: center; display: inline-block;">
	                 		<input type="text" class="form-control" id="ln" style="width: 240px; text-align: center; display: inline-block;">
	                 		<button type="submit" class="btn btn-default" style="width: 60px; display: inline-block;" id="set">확인</button> 
	                 	<br><br></div>
	                 <div class="map_wrap">
					        ...
					        <div class="option">
					            <div>
					                <form onsubmit="searchPlaces(); return false;">
						                    <input type="text" value="" id="keyword" class="form-control" style="width: 160px; display: inline-block;"> 
						                    <button type="submit" class="btn btn-default" style="width: 60px; display: inline-block;">검색</button> 
						                </form>
						            </div>
						        </div>
						        <hr>
