                            ...
                            <fieldset style="text-align: center;">
                                ...
                                <div class="form-group row" style="text-align: center;">
                                    <div class="form-group" style="width: 45%; position: relative; display: inline-block;">
                                   		<input type="text" class="form-control form-control-lg" placeholder="인증번호">
                               		</div>
                               		 <div class="form-group" style="width: 45%; position: relative; display: inline-block;">
                                   		<input type="text" class="form-control form-control-lg" placeholder="인증번호">
                               		</div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-4 col-md-7" style="margin-left: 33.8%;">
                                        <button type="submit" class="btn btn-primary">승리</button>
                                        <button type="button" class="btn btn-inverse">무승부</button>
                                    </div>
                                </div>
                            </div>
                        </form>
