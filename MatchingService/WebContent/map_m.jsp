...
<head>
    ...
    <script type="text/javascript">
    	...
    	function setPlace(place) {
    		opener.document.getElementById("ground_name").value=place;
    		this.close();
    	}
    </script>
  	<style type="text/css">
...
<body>
	         <div class="col-lg-12"><br>
	             <section class="widget">
	                 	<div style="text-align: center;"><input type="text" class="form-control" id="pl" style="width: 242px; text-align: center; display: inline-block;">
