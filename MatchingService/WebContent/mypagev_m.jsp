                        ...
                        <div class="row">
                            <div class="col-md-5 text-xs-center">
                             ...
                             <div class="post-user post-user-profile">
                                    ...
                                    <h5 style="text-align: center; font-weight: bold;"><s:property value="%{player.user_Name}"/><span class="fw-semi-bold" id="user_Id"></span></h5>
                                    <%-- <p style="text-align: center; margin-left: -5%;" id="team_Name">[<s:property value="%{player.user_Id}"/>]</p> --%>
                                    <ul style="margin-left: -14%; list-style-type: none;">
                            ...
                            <div class="col-md-7" style="margin-right: 33.5%;">
                                <div class="stats-row stats-row-profile mt text-xs-right">
                                    <div class="stat-item">
                                        <p id="win" style="font-size: 2em;"><s:property value="%{aver}"/>%</p>
                                        <h6 class="name">평균 승률</h6>
                                    </div>
                                    <%-- <div class="stat-item">
                                        <p id="manner"><s:property value="%{player.user_Manner}"/></p>
				            	...
				            	<div class="search-result-item-body">
					            	<!-- <div class="row"> -->
						            	<div class="col-md-9" style="text-align: center;">
							            	<s:if test="game_Draw != null && winner_Id != null"><h5 class="search-result-item-heading" style="font-weight: bold;"><s:property value="game_Type" /></h5></s:if>
							            	<s:if test="game_Draw == null && winner_Id == null"><div style="margin-right: 23%;"><span class="label label-pill label-danger fw-normal pull-xs-right">게임이 성사되었습니다!</span></div><br></s:if></h5>
							            	<s:if test="game_Draw != null && winner_Id != null">
							            	<p class="info">경기시간 : 
