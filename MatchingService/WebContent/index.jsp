               ...
               <header id="header">
                  ...
                  <nav>
                     <ul><!-- 인덱스 분기_MatchingAction -->
                        <li><s:a action="intro" class="fa fa-circle" id="soccer"><span>Soccer</span></s:a></li>
                        <li><s:a action="intro" class="fa fa-dribbble" id="baseball"><span>Baseball</span></s:a></li>
                        <li><s:a action="intro" class="fa fa-circle-o" id="tableTennis"><span>Table Tennis</span></s:a></li>
                        <li><s:a action="intro" class="fa fa-dot-circle-o" id="bowling"><span>Bowling</span></s:a></li>
                     </ul>
                  </nav>
               </header>
            <!-- Footer -->
